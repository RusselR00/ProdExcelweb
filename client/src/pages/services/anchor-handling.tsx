...
export default function AnchorHandling() {
    return (
        <Layout>
            {/* Hero Section */}
                ...
                <div className="relative container z-10 mx-auto px-4 md:px-6 text-center md:text-left pt-8 md:pt-20">
                    <div className="max-w-3xl mx-auto md:mx-0 bg-[#0a2540]/60 backdrop-blur-xl rounded-3xl p-6 md:p-10 border-2 border-white/30 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold text-white leading-tight mb-6 drop-shadow-2xl">
                            Anchor <span className="text-[#ffa559]">Handling</span>
                        </h1>
                        <p className="text-lg md:text-xl text-white/95 font-medium mb-8 max-w-xl leading-relaxed drop-shadow-lg">
                            Expert assistance in anchor deployment and retrieval for offshore rigs and installations.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-slate-600 leading-relaxed text-lg mb-8">
                            Our specialized Anchor Handling Tug (AHT) services provide critical support for offshore oil and gas operations. With DP2 dynamic positioning capability and experienced crews, we ensure precise and safe anchor deployment, retrieval, and rig positioning operations.
                        </p>

                        <div className="grid md:grid-cols-2 gap-6 mb-12">
                            {[
                                "Anchor Deployment & Recovery",
                                "Rig Positioning & Moving",
                                "Anchor Pattern Running",
                                "Platform Installation Support",
                                "Subsea Equipment Handling",
                                "Emergency Anchor Response"
                            ].map((feature, i) => (
                        ...
                        <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-lg mb-8">
                            <h3 className="text-2xl font-heading font-bold text-primary mb-4">Technical Capabilities</h3>
                            <div className="space-y-4">
                                <div>
                                    <h4 className="font-bold text-lg text-slate-900 mb-2">DP2 Dynamic Positioning</h4>
                                    <p className="text-slate-600">Class II dynamic positioning system ensures precise vessel positioning in challenging offshore conditions.</p>
                                </div>
                                <div>
                                    <h4 className="font-bold text-lg text-slate-900 mb-2">High Bollard Pull</h4>
                                    <p className="text-slate-600">80+ metric tons bollard pull capacity for handling heavy anchors and equipment in deep water operations.</p>
                                </div>
                                <div>
                                    <h4 className="font-bold text-lg text-slate-900 mb-2">Advanced Navigation</h4>
                                    <p className="text-slate-600">State-of-the-art positioning and navigation systems for accurate anchor placement and pattern running.</p>
                                </div>
                            </div>
                        </div>
